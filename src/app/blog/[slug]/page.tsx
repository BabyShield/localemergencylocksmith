...
const POST_CONTENT: Record<string, { body: string; faqs: { q: string; a: string }[] }> = {
...
My number is ${SITE_CONFIG.phone} — I answer 24/7 and I'll tell you exactly how long I'll be and exactly what it will cost.
...
Call ${SITE_CONFIG.phone} to book.
    `.trim(),
    faqs: [
...
For Coventry and Warwickshire, you can call me directly on ${SITE_CONFIG.phone}. I'll give you a firm price on the phone, every time.
    `.trim(),
    faqs: [
    ...
    <>
      ...
      <article className="py-12 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          {/* Related links */}
          <div className="mt-8">
            <h3 className="text-lg font-bold text-gray-900 mb-4">More from the Blog</h3>
