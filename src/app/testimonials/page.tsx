...
export const metadata: Metadata = {
  ...
  description:
    'Check current public feedback for the linked locksmith profile. This site does not republish ratings or review extracts without a traceable source record.',
  alternates: {
  ...
  openGraph: {
    ...
    locale: 'en_GB',
    title: 'Customer Review Information | Coventry Locksmith',
    description: 'Use the linked public profile to check feedback currently attributed there.',
    ...
    <>
      ...
      <section className="px-4 py-14">
        <div className="mx-auto max-w-3xl rounded-2xl border border-gray-200 bg-[#F7F7F5] p-8 text-center">
          <h2 className="mb-3 text-2xl font-black text-[#0F1B2D]">View the linked public profile</h2>
          <p className="mx-auto mb-7 max-w-xl leading-relaxed text-gray-600">
            Open the profile directly to see the name, feedback and other business details that
            Google currently displays. Check that those details match the business you intend to contact.
          </p>
          <a
