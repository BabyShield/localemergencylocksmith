...
export const metadata: Metadata = {
  ...
  description: 'Happy with our service? Leave a Google review — it helps other Coventry residents find a trusted local locksmith.',
    ...
    <section className="py-16 px-4">
      <div className="max-w-xl mx-auto text-center">
        ...
        <div className="bg-[#F7F7F5] rounded-xl p-6 text-left border border-gray-200">
          ...
          <ul className="space-y-2 text-sm text-gray-600">
            <li className="flex gap-2">
              ...
              What brought you to call us (lockout, lock change, repair?)
            </li>
            <li className="flex gap-2">
              <span className="text-[#FFB800] font-bold">&#10003;</span>
              How quickly we arrived
            </li>
            <li className="flex gap-2">
              <span className="text-[#FFB800] font-bold">&#10003;</span>
              How the job went
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <p className="text-gray-500 text-sm mb-2">Need us again? Save this number:</p>
          <a
