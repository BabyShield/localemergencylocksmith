...
export const BLOG_SEARCH_TITLES: Record<string, string> = {
  ...
  'emergency-locksmith-cost-coventry-2026': 'Coventry Locksmith Quote Guide for 2026',
  'emergency-locksmith-charges-explained': 'Emergency Locksmith Night Charges: What to Ask',
...
export const BLOG_META_DESCRIPTIONS: Record<string, string> = {
  ...
  'emergency-locksmith-cost-coventry-2026': 'Learn how to compare Coventry locksmith quotes, including labour, parts, VAT, call-out fees and the findings that can change a total.',
