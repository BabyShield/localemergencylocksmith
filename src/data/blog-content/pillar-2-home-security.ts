...
export const PILLAR_2_CONTENT: Record<string, { body: string; faqs: { q: string; a: string }[] }> = {
...
Like doors, windows achieve SBD certification through PAS 24 testing. The entire window unit — frame, glass, hardware, and locks — is tested as a complete unit.
