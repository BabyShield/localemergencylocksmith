...
- **New installation vs replacement** — if I am fitting a mortice lock where there was not one before, the door needs morticing (cutting a rectangular pocket). This takes longer and costs more
...
- **Brand** — Mila, Yale, GU (Gretsch-Unitas), Lockmaster, Fuhr, Winkhaus, and others all make different mechanisms
...
For all our lock services, visit the [lock change](/services/lock-change) page or check our full [price list](/prices). If your uPVC door is jammed and you cannot get in or out, visit our [emergency lockout](/services/emergency-lockout) page.`,
  ...
  'rekey-or-replace-locks': {
    body: `## Rekey or Replace? How to Decide What Your Locks Need
...
1. The locksmith removes the cylinder from the lock (or the plug from the cylinder)
2. The existing pins are removed
3. New pins are inserted that match a new key configuration
4. The cylinder is reassembled and tested
5. You get a new set of keys
