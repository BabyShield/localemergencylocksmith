...
- **Extraction plus cylinder replacement** (if the lock is damaged or the key cannot be removed without disassembly): from **£59** including a new standard cylinder, or from **£89** with an anti-snap cylinder upgrade
...
- **Euro cylinder replacement** (uPVC or composite door): from **£69** for a standard anti-snap cylinder fitted
...
For more on avoiding locksmith scams, see the blog post on [why you should never use a locksmith who will not give a price on the phone](/blog/locksmith-wont-give-price-on-phone).`,
    faqs: [
      ...
      },
      {
        ...
        a: 'This is extremely common and nothing to worry about. I have several alternative ways to verify you live at the property: a neighbour who can vouch for you, photos on your phone taken inside the property, vehicle registration at the address, a delivery app showing your address, or even post visible through the letterbox with your name on it. I am not trying to make things difficult — I just need to satisfy myself that I am letting the right person in. In years of doing this I have always been able to verify identity one way or another.',
      },
      {
...
- **Install a keysafe.** A combination-code lockbox mounted discreetly on an outside wall. Costs £30-50 and means you always have a spare key accessible. Popular with elderly residents and families.
    ...
    faqs: [
      {
        ...
        a: 'No — the fire brigade does not charge for call-outs. However, they will only attend a lockout if there is a genuine risk to life (for example, a child or vulnerable person trapped inside). For a standard lockout with no one at risk, they will decline to attend and advise you to call a locksmith. And even though the fire brigade call-out itself is free, the damage from forced entry will cost you hundreds of pounds to repair — a replacement uPVC door alone costs £400-£800. A locksmith costs from £59 for non-destructive entry.',
      },
      {
      ...
      },
      {
        ...
        a: 'Stay somewhere safe and warm. If a neighbour is in, ask if you can wait inside. If not, sit in your car if you have one. If it is late at night and you feel uncomfortable, go to the nearest open shop, petrol station, or public place and let me know where you will be — I will come to you first. Do not try to force your way in through a window — you risk injury and damage, and your insurance will not cover self-inflicted damage. I will be with you in 15-30 minutes across Coventry.',
      },
    ],
  },
}
