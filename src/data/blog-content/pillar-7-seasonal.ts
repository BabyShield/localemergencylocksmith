// Pillar 7: Seasonal Security Guides — full blog post content

export const PILLAR_7_CONTENT: Record<string, { body: string; faqs: { q: string; a: string }[] }> = {

  // ──────────────────────────────────────────────
  // 1. Dark Evenings & Burglary — October
  // ──────────────────────────────────────────────
...
`,
  ...
  // ──────────────────────────────────────────────
  // 2. How to Stop Locks Freezing in Winter
  // ──────────────────────────────────────────────
  'how-to-stop-locks-freezing-winter': {
    body: `
...
`,
    faqs: [
      ...
      },
      {
        ...
        a: 'No. Boiling water causes thermal shock — the extreme temperature difference can crack a euro cylinder, damage the finish on your door, and even crack glass if it splashes. Use lukewarm water instead (roughly bath temperature). It melts the ice without risking damage to the lock or door.',
      },
      {
...
`,
  ...
  // ──────────────────────────────────────────────
  // 4. Summer Holiday Security Checklist
  // ──────────────────────────────────────────────
...
1. Lift handle and turn key on every uPVC/composite door
2. Lock every window in every room
3. Set timer lights in two rooms minimum
4. Arrange daily post collection
5. Cancel deliveries and subscriptions
6. Brief a neighbour — drive, bins, visual checks
7. Lock shed and garage, secure tools and ladders
8. Remove hidden keys, install key safe if needed
9. Do not post holiday plans on social media
10. Do a final walk-around: front, back, side, garage, shed
...
`,
    faqs: [
      ...
      },
      {
        ...
        a: 'Lock everything inside your shed or garage. Ladders, spades, crowbars, and other tools can all be used to force entry into your home. Your shed should have a proper hasp and padlock — not a cheap combination lock. Your garage should be locked on both the main door and any internal door leading into the house. Do not leave anything outside that could help a burglar.',
      },
    ],
  },

  // ──────────────────────────────────────────────
  // 5. Moving House — Change Your Locks
  // ──────────────────────────────────────────────
  'moving-house-change-locks': {
    body: `
## You Have the Keys — But Who Else Does?
...
1. How many external doors need changing
2. What type of doors they are (uPVC, composite, wooden)
...
`,
  ...
  // ──────────────────────────────────────────────
  // 6. Student Move-In Security Guide
  // ──────────────────────────────────────────────
...
1. Check front door lock — does it deadlock properly?
2. Check back door lock — does it lock at all?
3. Check all window locks — especially ground floor
4. Check your bedroom door lock
5. Report any broken or missing locks to your landlord in writing
6. Agree a house rule: last person out locks the door
...
`,
  ...
  // ──────────────────────────────────────────────
  // 8. New Year Home Security Audit
  // ──────────────────────────────────────────────
  'new-year-home-security-audit': {
    body: `
## Start the New Year With a 30-Minute Security Audit
...
### Scoring
- All locks working perfectly, anti-snap cylinder, solid handle: **5/5**
- Locks working but standard cylinder (not anti-snap): **3/5**
- Any stiffness, incomplete locking, or protruding cylinder: **2/5**
- Lock not engaging properly or obviously damaged: **1/5**
...
### Scoring
- All locks working, anti-snap cylinder, solid frame: **5/5**
- Locks working but basic cylinder or no deadlock: **3/5**
- Frame damage, stiffness, or incomplete locking: **2/5**
- Door does not lock properly: **1/5**
...
- All windows lock but no sash jammers: **3/5**
- Some windows do not lock properly: **2/5**
- Multiple broken window locks: **1/5**
...
- Garage door secured but internal door is basic: **2/3**
- Garage door unsecured or no internal door lock: **1/3**
...
### Scoring
- Proper hasp with coach bolts and closed-shackle padlock: **3/3**
- Padlock fitted but basic quality: **2/3**
- Cheap lock, weak hasp, or unsecured: **1/3**
...
- One working light or partially functional: **1/2**
- No external lighting: **0/2**
...
- Keys mostly accounted for, no key safe: **1/2**
- Unsure who has keys: **0/2**
...
`,
    faqs: [
      {
        q: 'How often should I do a home security audit?',
