...
const LOCAL_SOURCES = {
  ...
  'gazette-nuneaton-conservation-2022': {
    ...
    title: 'Notice of Variation of Nuneaton and Bedworth Town Centre Conservation Areas',
    publisher: 'The Gazette, published by authority',
    url: 'https://www.thegazette.co.uk/notice/4289465',
    supports: 'The 15 February 2022 confirmation of defined Nuneaton and Bedworth Town Centre Conservation Area boundary changes, including named Nuneaton additions and the Bedworth addition at 10-16 High Street.',
    checkedOn: PROMOTION_REVIEWED_ON,
    kind: 'property-status',
  },
  'historic-england-61-coton-road-1034982': {
    id: 'historic-england-61-coton-road-1034982',
    title: '61 Coton Road, list entry 1034982',
    publisher: 'Historic England',
    url: 'https://historicengland.org.uk/listing/the-list/list-entry/1034982',
    supports: 'The Grade II designation, statutory 61 Coton Road address and legacy description of a recessed plain C20 door and painted moulded doorcase at the exact Nuneaton asset.',
    checkedOn: PROMOTION_REVIEWED_ON,
    kind: 'property-status',
  },
  'nbbc-newtown-community-centre': {
    id: 'nbbc-newtown-community-centre',
    title: 'Newtown Community Centre',
    publisher: 'Nuneaton and Bedworth Borough Council',
    url: 'https://www.nuneatonandbedworth.gov.uk/community-facilities/community-centres-1/8',
    supports: 'The council facility name and CV11 4HG postcode, its narrative location at the corner of Newtown Road, day-to-day management by WCAVA and references to ramped front and rear entrances; the page address line contains an inconsistent road spelling.',
    checkedOn: PROMOTION_REVIEWED_ON,
    kind: 'locality',
  },
  ...
  'historic-england-st-peter-galley-common-1389490': {
    id: 'historic-england-st-peter-galley-common-1389490',
    title: 'Church of St Peter, Galley Common, list entry 1389490',
    publisher: 'Historic England',
    url: 'https://historicengland.org.uk/listing/the-list/list-entry/1389490',
    supports: 'The Grade II designation, list entry number, Galley Common statutory asset identity and legacy description distinguishing the west-end aisle porches and west-front return porches at the Church of St Peter.',
    checkedOn: PROMOTION_REVIEWED_ON,
    kind: 'property-status',
  },
  'nhs-galley-common-medical-centre-m84008001': {
    id: 'nhs-galley-common-medical-centre-m84008001',
    title: 'Galley Common Medical Centre',
    publisher: 'NHS',
    url: 'https://www.nhs.uk/services/gp-surgery/galley-common-medical-centre/M84008001',
    supports: 'The current NHS profile name and Valley Road, Galley Common, Nuneaton CV10 9NH address for Galley Common Medical Centre.',
    checkedOn: PROMOTION_REVIEWED_ON,
    kind: 'locality',
  },
  ...
  'wcc-list-of-streets-2026': {
    ...
    supports: 'The 11 August 2026 county Street, Locality and Town entries, including selected Attleborough, Stockingford, Weddington, Horeston Grange, Whitestone, Camp Hill, Chapel End and Galley Common locality entries, selected Nuneaton and Bedworth town-field entries, Tiverton Drive\'s Horeston Grange label, Camp Hill Road\'s blank locality, and Bermuda-labelled roads in Nuneaton.',
    checkedOn: PROMOTION_REVIEWED_ON,
    kind: 'locality',
  },
  ...
  'historic-england-chapel-end-congregational-church-1262600': {
    id: 'historic-england-chapel-end-congregational-church-1262600',
    title: 'Chapel End Congregational Church, list entry 1262600',
    publisher: 'Historic England',
    url: 'https://historicengland.org.uk/listing/the-list/list-entry/1262600',
    supports: 'The Grade II designation, Coleshill Road statutory address and legacy description of the central round-arched entrance with panelled double doors at Chapel End Congregational Church.',
    checkedOn: PROMOTION_REVIEWED_ON,
    kind: 'property-status',
  },
  'nhs-chapel-end-surgery-m84005': {
    id: 'nhs-chapel-end-surgery-m84005',
    title: 'Chapel End Surgery',
    publisher: 'NHS',
    url: 'https://www.nhs.uk/services/gp-surgery/chapel-end-surgery/M84005',
    supports: 'The current NHS profile name and 10 Camp Hill Road, Nuneaton CV10 0JH address for Chapel End Surgery.',
    checkedOn: PROMOTION_REVIEWED_ON,
    kind: 'locality',
  },
  'nbbc-borough-plan-review-2021-2039': {
    ...
    supports: 'The plan adopted on 10 December 2025, including the Chapel End local-centre entry, Horeston Grange and Camp Hill-Copper Beech Road district-centre entries and Strategic Policy DS5\'s bounded wider Bermuda Park employment context.',
    checkedOn: PROMOTION_REVIEWED_ON,
    kind: 'locality',
  },
  ...
  'historic-england-bedworth-water-tower-1116416': {
    id: 'historic-england-bedworth-water-tower-1116416',
    title: 'Water Tower, Tower Road, Bedworth, list entry 1116416',
    publisher: 'Historic England',
    url: 'https://historicengland.org.uk/listing/the-list/list-entry/1116416',
    supports: 'The Grade II designation, Tower Road statutory address and legacy description of the deeply recessed double-leaf moulded six-panelled doors and fanlight at the exact Bedworth asset, which the entry describes as disused.',
    checkedOn: PROMOTION_REVIEWED_ON,
    kind: 'property-status',
  },
  ...
  'wcc-cawston-grange-primary-school': {
    ...
    supports: 'The current school-directory name, academy classification and Scholars Drive, Rugby CV22 7GU contact address.',
    checkedOn: PROMOTION_REVIEWED_ON,
    kind: 'locality',
  },
  'rbc-cawston-parish-council': {
    id: 'rbc-cawston-parish-council',
    title: 'Cawston parish council details',
    publisher: 'Rugby Borough Council',
    url: 'https://services.rugby.gov.uk/web/guest/l/6734048',
    supports: 'The current parish-council record and its Cawston Community Hall, Scholars Drive, Rugby CV22 7GU contact location.',
    checkedOn: PROMOTION_REVIEWED_ON,
    kind: 'locality',
  },
  'historic-england-cawston-farm-house-1390996': {
    id: 'historic-england-cawston-farm-house-1390996',
    title: 'Cawston Farm House, list entry 1390996',
    publisher: 'Historic England',
    url: 'https://historicengland.org.uk/listing/the-list/list-entry/1390996',
    supports: 'The Grade II designation and Coventry Road statutory address for the named Cawston Farm House in Dunchurch parish.',
    checkedOn: PROMOTION_REVIEWED_ON,
    kind: 'property-status',
  },
  ...
  'rbc-new-bilton-orchard-2024': {
    id: 'rbc-new-bilton-orchard-2024',
    title: 'New orchard promises to bear fruit for New Bilton',
    publisher: 'Rugby Borough Council',
    url: 'https://www.rugby.gov.uk/w/new-orchard-promises-to-bear-fruit-for-new-bilton',
    supports: 'The dated 14 March 2024 statement that work had started on a community orchard at Jubilee Recreation Ground, described as the recreation ground in Bridle Road.',
    checkedOn: PROMOTION_REVIEWED_ON,
    kind: 'locality',
  },
...
const AREA_FAQS: Partial<Record<AreaSlug, [AreaFaq, AreaFaq]>> = {
  nuneaton: [
    { q: 'What do the selected Nuneaton records identify?', a: `They identify selected town-field street entries, exact 2022 conservation-area additions, the listed asset at 61 Coton Road and Newtown Community Centre. They prove no current lock, fault, keyholder or access right.` },
    { q: 'How should a Nuneaton entrance be confirmed?', a: `Provide the complete address, building or unit, exact private or managed threshold and authorised controller. Confirm the community-centre address directly because its council page contains inconsistent road spelling.` },
  ],
  attleborough: [
  ...
  bedworth: [
    { q: 'What do the selected Bedworth records identify?', a: `They identify selected town-field street entries, the exact 2022 High Street conservation addition, the listed Tower Road water tower and Bedworth Library. Each source has a separate and bounded scope.` },
    { q: 'How should a Bedworth threshold be distinguished?', a: `Give the complete address, exact opening and authorised controller. Do not infer that the library at 18 High Street is within the separately recorded 10-16 High Street conservation addition.` },
  ],
  bulkington: [
  ...
  cawston: [
    { q: 'What do the current Cawston records establish?', a: `They identify a Scholars Drive school, a parish-council contact location, the Grade II Cawston Farm House and dated county-map labels. They do not establish a requested entrance, present controller, access, hardware or condition.` },
    { q: 'What information should a Cawston caller provide?', a: `Provide the full postal address, building or unit, exact threshold, controller and current site-access instructions; named-site, listed-asset and map records cannot replace them.` },
  ],
  'long-lawford': [
...
export const NORTH_EAST_AREA_GUIDES = {
  nuneaton: makeGuide({
    ...
    summary: [
      `Warwickshire County Council's street register produced on 11 August 2026 lists Abbey Gate, Abbey Green and Abbey Street with Nuneaton in the Town field. The Gazette separately confirms exact additions to Nuneaton Town Centre Conservation Area on 15 February 2022. The highway entries and variation notice answer different address and property-status questions.`,
      `Historic England lists 61 Coton Road at Grade II and records a recessed plain C20 door within a painted moulded doorcase in its legacy description. The borough council separately identifies Newtown Community Centre at CV11 4HG, with day-to-day management by WCAVA and front and rear entrance references. Its address line and narrative spell the road differently, so the full current address must be confirmed rather than silently normalised.`,
    ],
    accessGuidance: `Give the complete Nuneaton postal address, building or unit, exact external, shared or internal threshold and authorised controller. For Newtown Community Centre, use CV11 4HG but confirm the road spelling, instructed entrance and live site contact directly because the council page is internally inconsistent. For 61 Coton Road, first match the exact listed asset before applying its legacy doorway description.`,
    evidenceLimits: `The street register concerns highways maintained at public expense and does not define a locality, property or access right. The Gazette identifies bounded 2022 additions, Historic England describes one exact listed asset using legacy text, and the community-centre page supplies no current keyholder, lock, condition or work authority. None proves demand, service history, availability, coverage, journey conditions, response time or outcome.`,
    facts: [
      {
        heading: 'Nuneaton town-field street entries',
        text: `The county street register produced on 11 August 2026 lists Abbey Gate, Abbey Green and Abbey Street with Nuneaton in the Town field.`,
        sourceIds: ['wcc-list-of-streets-2026'],
        serviceRelevance: `Use these selected entries to prompt a complete address check only; the highway register does not define a property, approach, controlled opening or authority.`,
      },
      {
        heading: 'Nuneaton 2022 conservation additions',
        text: `The Gazette records that Nuneaton Town Centre Conservation Area boundary changes were confirmed on 15 February 2022, including additions at 23a and 23b Queens Road and 5 and 26 Bridge Street.`,
        sourceIds: ['gazette-nuneaton-conservation-2022'],
        serviceRelevance: `Apply the notice only to the exact named property and check the current map before visible alteration; it establishes no controller, door, hardware or fault.`,
      },
      {
        heading: '61 Coton Road listed doorway record',
        text: `Historic England lists 61 Coton Road, Nuneaton at Grade II as entry 1034982; its legacy description identifies a recessed plain C20 door and painted moulded doorcase.`,
        sourceIds: ['historic-england-61-coton-road-1034982'],
        serviceRelevance: `The designation and description apply only to this exact asset and are not a current condition, use, hardware, access or keyholder survey.`,
      },
      {
        heading: 'Newtown Community Centre site record',
        text: `The borough council identifies Newtown Community Centre at CV11 4HG, states that WCAVA manages it day to day and refers to ramped access at front and rear entrances.`,
        sourceIds: ['nbbc-newtown-community-centre'],
        serviceRelevance: `Confirm the complete current address, exact entrance and authorised contact directly because the page's address line and narrative use inconsistent road spelling and establish no lock or work authority.`,
      },
    ],
    sources: [
      LOCAL_SOURCES['wcc-list-of-streets-2026'],
      LOCAL_SOURCES['gazette-nuneaton-conservation-2022'],
      LOCAL_SOURCES['historic-england-61-coton-road-1034982'],
      LOCAL_SOURCES['nbbc-newtown-community-centre'],
    ],
    serviceGuidance: {
      'emergency-lockout': {
        localFactIndexes: [0, 3],
        heading: 'Nuneaton lockouts with town entry and centre checked',
        body: [
          `Abbey Gate, Abbey Green and Abbey Street appear with Nuneaton in the county register's Town field, but that highway entry does not identify a building, unit or locked opening. Record the full number, postcode, building or unit and exact private, shared or internal threshold. If the instruction concerns Newtown Community Centre, retain CV11 4HG while confirming the road name directly because the council page's address line and narrative differ. Name the front, rear or other entrance and obtain the current authorised site contact rather than treating the facility name or ramped-access reference as permission.`,
          `Those official records help distinguish an address and managed site, not the fitted lock or opening method. Verify the requester's identity and connection to the selected threshold before examining key response, latch or deadlock state, door position and existing damage. Photograph the leaf, frame and visible furniture before any component is removed. MLA service-call material supports providing available price information in advance and checking identity and authority; if the service-call price changes, obtain agreement before the revised charge applies. Document drilling, component replacement and reinstatement separately, without assuming that a Nuneaton town entry or community-centre listing grants access.`,
        ],
        checks: ['Confirm the Nuneaton street number and postcode', 'Resolve the Newtown Centre road-name inconsistency', 'Name the locked threshold and live controller'],
      },
      'lock-change': {
        localFactIndexes: [1, 2],
        heading: 'Nuneaton lock changes at added or listed addresses',
        body: [
          `The 2022 variation names specific Nuneaton conservation additions, including 23a and 23b Queens Road and 5 and 26 Bridge Street; it does not extend that status to a similar street number elsewhere. Historic England's separate entry applies only to 61 Coton Road. Establish the complete address, exact threshold and current controller, then state whether the requested change concerns lost-key control, wear, damage or another documented objective. At Coton Road, confirm that the listed asset and affected opening match before using the legacy doorway wording as a fabric prompt.`,
          `The recessed plain C20 door and painted moulded doorcase are historical list-entry descriptions, not a current lock schedule or condition report. Photograph both hardware faces, the door edge, visible furniture and existing apertures, then record cylinder, case, keep and alignment as separate observations with their own markings and measurements. A compatible component using an existing opening presents a different question from new cutting or outward substitution. The written schedule should identify retained material, keys, fitting and adjustment, while any current map, owner, manager or property-specific fabric decision remains explicit rather than inferred from the 2022 notice or Grade II entry.`,
        ],
        checks: ['Match the Nuneaton address to the variation notice', 'Confirm whether 61 Coton Road is involved', 'Measure hardware without extending the legacy description'],
      },
      'upvc-lock-repair': {
        localFactIndexes: [0, 1, 3],
        heading: 'Nuneaton uPVC diagnosis at an exact verified entrance',
        body: [
          `Neither Nuneaton's town-field street entries, the conservation variation nor the Newtown Community Centre page establishes that an affected entrance is uPVC, composite or fitted with a multipoint mechanism. Confirm the complete address and door material from the booked opening. At the community centre, resolve the road-name inconsistency, name the front, rear or other door and identify the authorised facilities contact. Record key rotation, handle travel, locking-point movement and any safe difference between open and closed operation; these are observed symptoms, not a remote component diagnosis.`,
          `If the address is one of the named 2022 conservation additions, treat that as an exact-property prompt before work extends into visible material; the notice supplies no installed hardware or defect. Capture the whole faceplate, readable marks, centres, backset, locking layout, hinge position and frame contact before a compatible repair is specified. A managed centre threshold may also have access, egress or key-control requirements that must come from its present controller, not from the public venue page. The diagnostic record should keep measurements, safe tests, authority and any proposed door-or-frame intervention separate from the mechanism decision.`,
        ],
        checks: ['Verify the Nuneaton door material at site', 'Record Newtown open-versus-closed operation safely', 'Apply the 2022 addition only to its address'],
      },
      'boarding-up': {
        localFactIndexes: [2, 3],
        heading: 'Nuneaton boarding at listed and managed premises',
        body: [
          `A boarding instruction at 61 Coton Road and one at Newtown Community Centre concern different premises, controllers and fabric. First confirm the exact listed asset or the centre at CV11 4HG, then identify the damaged window or door and the person authorised to direct temporary securing. Neither official source reports an incident or present construction. Follow current police scene directions before disturbance, and photograph the point of entry, surviving frame, glazing or door, damaged hardware and adjacent surfaces before a covering hides those observations.`,
          `At 61 Coton Road, distinguish the affected opening from the legacy recessed-door and doorcase description and obtain current property-specific advice for any contact with verified listed fabric. At Newtown Community Centre, confirm the road spelling and instructed entrance rather than choosing between front and rear from the access wording alone. Record the opening measurements, remaining material, temporary method and material concealed, then list unresolved glazing, joinery, door, lock or structural work separately. The Grade II record and managed-site page establish neither a safe temporary method nor permission for permanent alteration.`,
        ],
        checks: ['Identify the damaged Nuneaton site opening', 'Preserve Coton Road or Newtown evidence first', 'Separate temporary covering from permanent fabric decisions'],
      },
      'lock-upgrade': {
        localFactIndexes: [1, 2, 3],
        heading: 'Nuneaton upgrades with three site contexts separated',
        body: [
          `The named 2022 conservation additions, listed 61 Coton Road asset and Newtown Community Centre are three separate Nuneaton contexts; none supplies a security rating or weakness. Match the exact address and controller before assessing the selected leaf, frame, hinges, keeps, handles, lock engagement and any cylinder projection. At the centre, obtain current access, egress and key-management requirements for the actual entrance after resolving the page's road-name inconsistency. At Coton Road, verify that the instruction concerns the listed asset and identify the specific doorway on site.`,
          `Historic England's recessed door and moulded doorcase wording is a legacy description, not a product recommendation. Photograph retained material and existing apertures, then distinguish adjustment, aperture-compatible component work and any new outward cutting or substitution needing current property-specific guidance. For a named conservation addition, apply only the relevant exact-address record; do not transfer it to the centre or another Nuneaton property. Each option should cite current manufacturer evidence and measured fit, identify retained parts and record owner, manager, alignment or fabric dependencies without suggesting that one component makes the complete entrance secure.`,
        ],
        checks: ['Name the exact Nuneaton status or managed context', 'Survey the selected Coton or Newtown door set', 'Match each upgrade option to measured fit'],
      },
    },
  }),
  ...
  'camp-hill': makeGuide({
    ...
    serviceGuidance: {
      'emergency-lockout': {
        localFactIndexes: [0, 3],
        heading: 'Resolve the Camp Hill street and CHESS threshold first',
        body: [
          `A Camp Hill lockout instruction should start with the complete number, street and postcode because the county register gives Camp Hill Drive a Camp Hill locality but leaves Camp Hill Road's locality blank. That difference can correct an address; it cannot identify a caller or prove access. Record whether the threshold is private, shared or managed and connect identity and authority to the exact door before testing the key, latch or deadlock or selecting an opening method.`,
          `If the request is for the CHESS Centre, use the council's 460 Cedar Road record only to identify that managed venue. Name the room or activity space, the external or internal door and a current authorised site contact rather than assuming a single venue entrance. The street and centre records predict no fitted lock or condition. Inspect the actual assembly and pre-existing damage, give available price information in advance and obtain fresh agreement before any inspection-led change to the service-call price takes effect.`,
        ],
        checks: ['Give the complete Camp Hill number, street and postcode', 'Name the exact private or CHESS Centre door', 'Connect authority to that threshold'],
      },
      'lock-change': {
        localFactIndexes: [1, 2],
        heading: 'Camp Hill tenure and district-centre checks before a lock change',
        body: [
          `The 2026 walkabout schedule groups selected roads under Camp Hill for housing engagement, but it does not prove that a particular address is council-owned, tenanted or shared. Ask who owns or manages the affected threshold and record why key control must change. The adopted plan separately names Camp Hill-Copper Beech Road as a district centre; at a centre booking, add the current organisation, unit and exact door rather than relying on the planning label as evidence of use or authority.`,
          `Obtain approval from the person responsible for that private, shared or business entrance, then inspect both faces of the furniture, the door edge, case or cylinder, keep and alignment. Photograph readable marks, measure the fitted component and check current operation before choosing repair or replacement. Neither housing-engagement geography nor a district-centre classification identifies a keying arrangement or product. The written Camp Hill scope should distinguish retained parts, adjustment, measured replacement, supplied keys and any building-management approval, with the source of every external requirement recorded.`,
        ],
        checks: ['Ask rather than infer who manages the Camp Hill threshold', 'Name the Copper Beech Road business or unit', 'Measure the fitted component before selection'],
      },
      'upvc-lock-repair': {
        localFactIndexes: [0, 1, 3],
      ...
      'boarding-up': {
        localFactIndexes: [2, 3],
        heading: 'District-centre and CHESS checks before Camp Hill boarding',
        body: [
          `A boarding request at the Camp Hill-Copper Beech Road district centre must identify the current business or organisation, unit, elevation and damaged opening; the planning classification lists no occupiers or entrances. At the CHESS Centre, distinguish the managed venue, room or activity space and exact external or internal opening at 460 Cedar Road. In either setting, obtain the current occupier or facilities contact able to approve temporary securing. The two council records say nothing about an incident, construction or safe attachment point.`,
          `Follow any police evidence-preservation direction before disturbing the scene, then photograph the point of entry, surviving frame, glazing or door material, damaged hardware and adjacent surfaces before covering them. Measure only the opening authorised by the responsible party and state intended coverage and proposed contact points, leaving concealed support capacity unresolved. The Camp Hill handover should identify what was covered and list glazing, joinery, door, lock and structural follow-up separately, without treating a district-centre or CHESS reference as condition evidence or permanent reinstatement.`,
        ],
        checks: ['Name the Camp Hill business, unit or CHESS space', 'Identify every authorised damaged opening', 'Record temporary and follow-on scopes separately'],
      },
      'lock-upgrade': {
        localFactIndexes: [0, 1, 2, 3],
  ...
  'chapel-end': makeGuide({
    ...
    reviewedOn: PROMOTION_REVIEWED_ON,
    summary: [
      `Warwickshire County Council's 11 August 2026 street register assigns selected entries including Alders Lane, Lincoln Avenue and Salisbury Drive to Chapel End, while the adopted Borough Plan separately names Chapel End as a local centre. Those records support address and unit checks only; neither defines a complete locality, current occupier or controlled entrance.`,
      `Historic England lists Chapel End Congregational Church on Coleshill Road at Grade II and describes its central round-arched entrance with panelled double doors. The NHS separately identifies Chapel End Surgery at 10 Camp Hill Road CV10 0JH. These are different exact sites whose present entrance and responsible contact must be confirmed independently.`,
    ],
    accessGuidance: `Give the complete Chapel End address, postcode, organisation or current business where relevant and exact external, shared or internal threshold. At the surgery, identify the instructed opening and authorised site contact; at the listed chapel, confirm whether the central entrance or another doorway is actually involved before applying the legacy description.`,
    evidenceLimits: `The street register is not a boundary, the planning tier does not list current units or occupiers, the NHS profile identifies one surgery address, and the Historic England entry applies only to one listed chapel. None proves caller authority, access, opening hours, current use, door material, hardware, condition, damage, route, service demand or outcome.`,
    facts: [
      {
        ...
        sourceIds: ['wcc-list-of-streets-2026'],
        serviceRelevance: `Use the labels to check a complete address only; the selected highway entries do not define the locality, a parcel, access route, controlled opening or service need.`,
      },
      {
        heading: 'Chapel End adopted local-centre role',
        text: `The Borough Plan Review adopted on 10 December 2025 lists Chapel End as a local centre intended for smaller-scale day-to-day top-up shopping needs.`,
        sourceIds: ['nbbc-borough-plan-review-2021-2039'],
        serviceRelevance: `At a centre booking, record the current business or unit, exact threshold and authorised contact; the planning tier supplies no occupier, entrance, controller, hardware or access right.`,
      },
      {
        heading: 'Chapel End listed chapel entrance',
        text: `Historic England lists Chapel End Congregational Church on Coleshill Road at Grade II as entry 1262600; its legacy description identifies a central round-arched entrance with panelled double doors.`,
        sourceIds: ['historic-england-chapel-end-congregational-church-1262600'],
        serviceRelevance: `The designation and doorway wording apply only to that exact chapel and are not a present condition, hardware, keyholder or access survey; identify the actual opening before fabric decisions.`,
      },
      {
        heading: 'Chapel End Surgery address record',
        text: `The NHS identifies Chapel End Surgery at 10 Camp Hill Road, Nuneaton, Warwickshire CV10 0JH.`,
        sourceIds: ['nhs-chapel-end-surgery-m84005'],
        serviceRelevance: `The profile identifies one healthcare site but no instructed doorway, current keyholder, caller authority, fitted hardware, fault, damage or safe access arrangement.`,
      },
    ],
    sources: [
      LOCAL_SOURCES['wcc-list-of-streets-2026'],
      LOCAL_SOURCES['nbbc-borough-plan-review-2021-2039'],
      LOCAL_SOURCES['historic-england-chapel-end-congregational-church-1262600'],
      LOCAL_SOURCES['nhs-chapel-end-surgery-m84005'],
    ],
    serviceGuidance: {
      'emergency-lockout': {
        localFactIndexes: [0, 3],
        heading: 'Chapel End lockouts at streets and surgery',
        body: [
          `Alders Lane, Lincoln Avenue and Salisbury Drive appear under Chapel End in the county register, but a selected street label does not identify the locked premises or opening. Record the full number, postcode, building or unit, floor where relevant and whether the threshold is private, shared or internal. If the call is at Chapel End Surgery, use the NHS address at 10 Camp Hill Road CV10 0JH and name the exact external or internal door rather than relying on the practice name alone.`,
          `Neither the street record nor the NHS profile identifies a current keyholder, caller authority, latch state or fitted lock. Confirm a live surgery representative or the responsible occupier for the precise opening, then inspect key response, deadlocking, door position and existing damage. MLA guidance separately supports verifying identity and authority, providing available price information in advance and obtaining agreement if the service-call price changes. Record any inspection-led method, removed component, reinstatement and later repair as separate items without inferring access from a public address.`,
        ],
        checks: ['Give the Chapel End number and postcode', 'Name the locked surgery or street threshold', 'Verify today\'s controller for that opening'],
      },
      'lock-change': {
        localFactIndexes: [1, 2],
        heading: 'Chapel End lock changes at centre or chapel',
        body: [
          `The adopted plan names Chapel End as a local centre but does not publish its current businesses, units, entrances or keying arrangements. For a centre instruction, record the trading name or managed unit, exact threshold, reason for change and the person responsible for shared or private keys. Photograph inside and outside furniture and the edge plate, then treat the cylinder, case, keep and alignment as separate inspection questions. The planning tier cannot select a component or establish permission to alter it.`,
          `If the job is at Chapel End Congregational Church, first confirm that the exact listed asset and affected doorway match the instruction. Historic England's central round-arched entrance and panelled double doors are legacy descriptions, not a current lock or condition report. Record existing apertures, visible furniture, markings and dimensions, and distinguish compatible component work from new cutting or outward alteration. The written scope should name retained parts, keys, fitting, adjustment and every owner, manager or property-specific fabric decision still outstanding.`,
        ],
        checks: ['Name the current business or listed asset', 'Record the key-control objective', 'Measure hardware before specifying replacement'],
      },
      'upvc-lock-repair': {
        localFactIndexes: [0, 1, 3],
        heading: 'Chapel End uPVC checks across distinct premises',
        body: [
          `Neither Chapel End's selected street entries nor its local-centre tier proves that an entrance is uPVC or composite. Confirm the complete address and material directly; at the centre, add the current business or unit, and at Chapel End Surgery identify the precise door and live site contact. Record key rotation, handle travel, locking-point movement and any safe difference between open and closed operation. Those observed symptoms, not the area label or healthcare address, frame the diagnostic question.`,
          `Before removing parts, establish whether the affected mechanism belongs to a private dwelling, shared centre entrance or surgery-controlled threshold and who can approve work there. Capture the full faceplate and readable markings and measure centres, backset, locking layout, hinges and keeps. Separate frame contact or alignment from an internal mechanism fault, and record any egress or management requirement supplied by the responsible party. The next-step note should state reproducible tests and measured compatibility without using planning or NHS records as hardware evidence.`,
        ],
        checks: ['Confirm the Chapel End site and door material', 'Log safe open-versus-closed Chapel End behaviour', 'Measure that threshold\'s complete locking arrangement'],
      },
      'boarding-up': {
        localFactIndexes: [2, 3],
        heading: 'Chapel End boarding at listed and managed sites',
        body: [
          `A boarding instruction at the listed chapel and one at Chapel End Surgery involve different controllers and fabric questions. Confirm the Coleshill Road listed asset or the NHS practice at 10 Camp Hill Road, then name the exact damaged opening and authorised representative. Follow current police scene directions before disturbance. Photograph the point of entry, remaining frame, glazing or door, damaged hardware and adjacent surfaces before a temporary covering conceals them; neither source reports an incident, construction or appropriate temporary method.`,
          `At the chapel, use the central double-door description only to identify possible legacy fabric and verify the actual opening on site; it does not prescribe a boarding method or report present condition. At the surgery, the public address does not identify facilities authority or an attachment surface. Agree the temporary boundary from inspected material, document every contact point and state what was covered. List unresolved glazing, joinery, door, lock and structural work separately, leaving permanent alteration and any property-specific approval to the responsible parties.`,
        ],
        checks: ['Verify the damaged Chapel End site opening', 'Preserve Chapel End evidence before covering', 'Separate Chapel End temporary and permanent scopes'],
      },
      'lock-upgrade': {
        localFactIndexes: [1, 2, 3],
        heading: 'Chapel End upgrades with sites and fabric separated',
        body: [
          `For a Chapel End local-centre upgrade, name the current business or unit and identify who controls the selected entrance; the planning tier establishes neither. At Chapel End Surgery, use 10 Camp Hill Road only to distinguish the site, then obtain the responsible party's access, egress and key-management requirements for the actual threshold. Inspect the leaf, frame, hinges, keeps, handles, lock engagement and any applicable cylinder fit as one assembly before comparing options.`,
          `If the exact asset is Chapel End Congregational Church, distinguish the central listed entrance from any other opening and photograph retained fabric and existing apertures. The legacy panelled-double-door description supplies no security rating, defect or product requirement. Separate adjustment, compatible component work and any new visible cutting, and seek current property-specific guidance for fabric decisions. Every proposal should cite current product evidence and measured fit, record manager or owner approval and state unresolved alignment or material dependencies without promising complete protection.`,
        ],
        checks: ['Name the Chapel End unit or managed site', 'Survey the selected Chapel End leaf and frame', 'Match each Chapel End option to measured fit'],
      },
    },
  }),
  'bermuda-park': makeGuide({
    ...
    serviceGuidance: {
      'emergency-lockout': {
        localFactIndexes: [0, 3],
        heading: 'Bermuda Park street and Phoenix Centre lockout checks',
        body: [
          `A Bermuda Park lockout should be booked against the complete number, road, unit and postcode because the county register uses Bermuda as the locality for Bermuda Road, Bermuda Village and Hazell Way. That label can help correct the address but does not define a service boundary, occupier or controlled door. Record whether the threshold is private, shared or managed and connect the caller's identity and authority to that exact opening before testing the key, latch or deadlock or selecting a method.`,
          `At Bermuda Phoenix Centre, distinguish the centre from the separate club on the same site, then name the relevant space, external or internal door and current authorised contact. The public venue record establishes no master-key system, fitted lock or access procedure. After authority is established, inspect the actual door, frame, key response and visible damage. Give available price information in advance, explain any inspection-led method or scope change and obtain fresh agreement before a changed service-call price applies, without treating a public address as permission.`,
        ],
        checks: ['Use the full Bermuda address and unit', 'Distinguish Phoenix Centre from the separate club', 'Identify the authorised controller for one door'],
      },
      'lock-change': {
        localFactIndexes: [1, 3],
        heading: 'Exact heritage-range and Phoenix checks for a Bermuda Park lock change',
        body: [
          `The council heritage and Article 4 records apply only to 20-118 even and 39-117 odd Bermuda Village, CV10 7PN. Match the complete number before using that evidence and do not infer that a door, lock or fitting is original, protected or defective. At Bermuda Phoenix, separately identify the centre or club, managed space and exact threshold. In both settings, record why key control must change and the current owner, occupier or facilities representative able to approve it.`,
          `Inspect both faces of the furniture, the door edge, case or cylinder, keep and alignment, then record readable marks, dimensions and present operation. For an exact heritage-range address, define any outward alteration before asking what property-specific requirement applies; for Phoenix, capture the site's written management or egress constraint for that door. Neither record selects hardware or grants work authority. The Bermuda Park scope should list retained parts, measured replacement, supplied keys, fitting, adjustment and each unresolved owner, manager or council question as separate items.`,
        ],
        checks: ['Match heritage evidence only to an exact Bermuda Village number', 'Name the Phoenix Centre or club threshold', 'Confirm the key-control decision-maker'],
      },
      'upvc-lock-repair': {
        localFactIndexes: [0, 1],
        heading: 'Bermuda Park address and exact heritage-range checks for uPVC repair',
        body: [
          `For a uPVC repair enquiry, capture the complete road, number, postcode and unit because official highway entries use Bermuda rather than Bermuda Park. The register cannot establish that the door is uPVC, composite or multipoint. Confirm the material at the actual threshold and record key rotation, handle travel, locking-point movement, frame contact and any safe difference between open and closed operation. Keep reproduced observations separate from the caller's report rather than assigning a component fault remotely.`,
          `If the address matches 20-118 even or 39-117 odd Bermuda Village, record the exact number and use the current heritage and Article 4 sources only for a defined outward alteration question. They provide no mechanism diagnosis or compatibility evidence and do not prove that the fitted door or lock is original. Photograph the complete faceplate and readable codes and measure centres, backset, locking layout, cylinder fit, hinges and keeps. Separate alignment, gearbox, strip and cylinder findings and retain the evidence behind any compatible shortlist.`,
        ],
        checks: ['Resolve the full Bermuda number and unit', 'Apply the heritage range only to an exact match', 'Measure the installed locking layout'],
      },
      'boarding-up': {
        localFactIndexes: [2, 3],
        heading: 'Employment-site and Phoenix checks before Bermuda Park boarding',
        body: [
          `The adopted plan describes the wider Bermuda Park area as an employment location but names no current occupier, unit or entrance. A business-site boarding request must therefore include the organisation, building, loading or public-facing unit, exact damaged opening and authorised facilities contact. At Bermuda Phoenix, distinguish the centre from the separate club and identify the relevant managed space and door. Neither source reports an incident, construction, present damage or a safe attachment point.`,
          `Scene control comes first: comply with any police restriction and wait until the affected Bermuda Park opening is released for inspection. Create a visual record of the entry point, remaining frame, glazing or door material, broken hardware and neighbouring surfaces. Agree the temporary span and proposed attachment positions with the verified controller, while marking hidden substrate capacity as unresolved. The completion note should say what evidence became concealed and itemise outstanding glazing, joinery, door, lock or structural work; employment policy and the Phoenix page cannot turn temporary protection into reinstatement.`,
        ],
        checks: ['Identify the Bermuda Park business, unit or Phoenix space', 'Name each authorised damaged opening', 'Document temporary and permanent tasks separately'],
      },
      'lock-upgrade': {
        localFactIndexes: [0, 1, 2, 3],
  ...
  'galley-common': makeGuide({
    ...
    reviewedOn: PROMOTION_REVIEWED_ON,
    summary: [
      `Warwickshire County Council's 11 August 2026 street register assigns selected entries including Auden Close, Chaucer Drive, Chesterton Drive and Orford Rise to Galley Common. It separately identifies Galley Common Infant School at Plough Hill Road CV10 9NZ. Those records support address and managed-site checks, not a complete boundary, access right or current controller.`,
      `Historic England lists the Church of St Peter, Galley Common at Grade II and distinguishes west-end aisle porches in its legacy description. The NHS separately identifies Galley Common Medical Centre at Valley Road CV10 9NH. Each named site requires its own exact opening and responsible contact; neither record reports present doors, locks, condition or authority.`,
    ],
    accessGuidance: `Give the complete Galley Common address, postcode, site name and exact external, shared or internal threshold. At the school, identify the gate, block or door and authorised facilities contact; at the medical centre, identify the instructed opening and live site contact; at St Peter's, distinguish the relevant porch or doorway on site before applying the listed record.`,
    evidenceLimits: `The street register is selected highway data, the school and NHS pages identify two exact managed sites, and the Historic England entry applies only to one listed church. None establishes a full locality, present keyholder, caller authority, opening hours, door material, installed hardware, condition, damage, route, service demand, response time or outcome.`,
    facts: [
      {
        ...
        sourceIds: ['wcc-list-of-streets-2026'],
        serviceRelevance: `Use the labels to check a complete address only; the selected entries do not define the locality, a property boundary, approach, controlled entrance or service need.`,
      },
      {
        heading: 'Galley Common Infant School address',
        text: `Warwickshire County Council identifies Galley Common Infant School as a community infant school at Plough Hill Road, Nuneaton, Warwickshire CV10 9NZ.`,
        sourceIds: ['wcc-galley-common-infant-school'],
        serviceRelevance: `The record identifies one managed site only and supplies no gate, building entrance, current keyholder, caller authority, door construction, hardware or work approval.`,
      },
      {
        heading: 'Galley Common St Peter porch record',
        text: `Historic England lists the Church of St Peter, Galley Common at Grade II as entry 1389490; its legacy description identifies narrow aisles with porches at their west ends and porches on the west-front returns.`,
        sourceIds: ['historic-england-st-peter-galley-common-1389490'],
        serviceRelevance: `The designation and porch wording apply only to the exact church and are not a present doorway, lock, condition, access or keyholder survey; identify the instructed opening on site.`,
      },
      {
        heading: 'Galley Common Medical Centre address',
        text: `The NHS identifies Galley Common Medical Centre at Valley Road, Galley Common, Nuneaton, Warwickshire CV10 9NH.`,
        sourceIds: ['nhs-galley-common-medical-centre-m84008001'],
        serviceRelevance: `The profile identifies one healthcare site but no instructed entrance, current keyholder, caller authority, fitted hardware, fault, damage or access arrangement.`,
      },
    ],
    sources: [
      LOCAL_SOURCES['wcc-list-of-streets-2026'],
      LOCAL_SOURCES['wcc-galley-common-infant-school'],
      LOCAL_SOURCES['historic-england-st-peter-galley-common-1389490'],
      LOCAL_SOURCES['nhs-galley-common-medical-centre-m84008001'],
    ],
    serviceGuidance: {
      'emergency-lockout': {
        localFactIndexes: [1, 3],
        heading: 'Galley Common lockouts at two managed sites',
        body: [
          `A lockout at Galley Common Infant School must identify the Plough Hill Road site, the specific gate, block or door and the authorised facilities representative; the county directory names no current keyholder or access arrangement. A medical-centre instruction requires the same precision at Valley Road CV10 9NH. Record the exact external, shared or internal threshold and the caller's connection to it before assessing latch state, deadlocking, key behaviour or existing damage.`,
          `The two public profiles distinguish managed sites but provide no fitted lock, authority chain or opening method. Obtain live approval for the named threshold, then document the door face, frame and visible furniture before any component is removed. For this Galley Common instruction, MLA material supports checking identity and authority and giving available price information before work; if the service-call price alters, secure agreement before the revised charge takes effect. Explain the inspection-led method and record drilling, replacement, reinstatement and follow-on work separately without assuming that a public contact address grants access.`,
        ],
        checks: ['Name the school or medical-centre opening', 'Verify the current authorised representative', 'Record door and frame condition'],
      },
      'lock-change': {
        localFactIndexes: [0, 2],
        heading: 'Galley Common lock changes with listed fabric identified',
        body: [
          `The county's Galley Common street labels can disambiguate Auden Close, Chaucer Drive, Chesterton Drive or Orford Rise, but they establish neither tenure nor the person responsible for a lock. Record the full number and postcode, private or shared threshold and reason for change, such as key control, failure or damage. Photograph both hardware faces and the edge plate, then treat the cylinder, case, keep and alignment as separate observations requiring their own markings and measurements.`,
          `At the Grade II Church of St Peter, identify the exact porch or doorway on site rather than converting the legacy west-end porch descriptions into a current hardware schedule. Confirm the authorised controller, photograph retained visible fabric and distinguish compatible component work within existing apertures from new cutting or outward change. The written schedule should list retained parts, measured replacement, keys, fitting, adjustment and any property-specific fabric decision, while the church record remains limited to that listed asset.`,
        ],
        checks: ['Give the full number and postcode', 'Define the present key-control need', 'Separate component and fabric decisions'],
      },
      'upvc-lock-repair': {
        localFactIndexes: [0, 1, 3],
        heading: 'Galley Common uPVC checks across exact sites',
        body: [
          `The street register, school directory and NHS profile do not establish that any Galley Common entrance is uPVC or composite. Confirm the complete address and door material directly; at the infant school, add the gate, block or doorway, and at the medical centre name the exact external or internal opening. For the Galley Common door, log key rotation, handle travel and locking-point movement, then note any safe open-versus-closed contrast. Those observations, not a locality or facility label, define the diagnostic starting point.`,
          `Obtain the responsible site's authority before covers or parts are removed, especially where the threshold is shared or subject to egress arrangements. Capture the complete faceplate and readable markings and measure centres, backset, locking layout, hinges and keeps. Separate frame contact or alignment from a suspected internal mechanism fault, and record the reproduced symptoms and management constraints. The proposal should identify measured compatibility and any unresolved test without treating a school or medical-centre address as evidence of a particular mechanism.`,
        ],
        checks: ['Name the Galley Common managed or private opening', 'Log safe Galley Common open-versus-closed behaviour', 'Measure that Galley Common locking arrangement'],
      },
      'boarding-up': {
        localFactIndexes: [2, 3],
        heading: 'Galley Common boarding at church or medical site',
        body: [
          `A boarding call at St Peter's and one at Galley Common Medical Centre concern different exact sites, controllers and fabric. Confirm the listed church or Valley Road CV10 9NH practice, name the damaged opening and obtain the current authorised representative. Follow police scene directions before disturbance, then photograph the point of entry, surviving frame, glazing or door, damaged hardware and adjacent surfaces. Neither official record reports an incident, current construction or safe attachment point.`,
          `At St Peter's, use the west-end porch descriptions only to label the inspected part of the exact listed asset; they do not prescribe a board or report present condition. At the medical centre, the NHS address does not identify facilities authority or the affected threshold. Agree the temporary boundary from observed material, document every fixing or contact point and state what will be concealed. List glazing, joinery, door, lock and structural follow-up separately from permanent alteration and any property-specific fabric decision.`,
        ],
        checks: ['Name the damaged Galley Common site opening', 'Preserve Galley Common evidence before covering', 'Separate Galley Common temporary and permanent scopes'],
      },
      'lock-upgrade': {
        localFactIndexes: [1, 2, 3],
        heading: 'Galley Common upgrades with sites and fabric separated',
        body: [
          `At Galley Common Infant School, identify the gate, block or door and obtain the authorised site's access, egress and key-management requirements; at the medical centre, use the Valley Road address only to distinguish the practice and name its actual threshold. Neither directory supplies an existing security level or weakness. Inspect the selected leaf, frame, hinges, keeps, handles, lock engagement and any applicable cylinder fit as one assembly before comparing correctly sized options with current accredited-product evidence.`,
          `For work at the Church of St Peter, distinguish the affected entrance from the legacy west-end porch descriptions and photograph retained listed fabric and existing apertures. The Grade II record selects no product and reports no present defect. At St Peter's, keep adjustment and aperture-compatible work distinct from new cuts or externally visible substitution, and assign unresolved fabric choices to current property-specific advice. The specification should state measured fit, current manufacturer evidence, site approval and unresolved alignment or material dependencies without claiming that one product makes a Galley Common entrance completely secure.`,
        ],
        checks: ['Name the Galley Common site and controller', 'Survey the selected Galley Common leaf and frame', 'Match each Galley Common option to measured fit'],
      },
    },
  }),
  hartshill: makeGuide({
  ...
  bedworth: makeGuide({
    ...
    reviewedOn: PROMOTION_REVIEWED_ON,
    summary: [
      `Warwickshire County Council's street register produced on 11 August 2026 lists Acacia Crescent, Alexander Road and All Saints Square with Bedworth in the Town field. The Gazette separately records a conservation-boundary variation confirmed on 15 February 2022, including the addition of 10-16 High Street. The highway and property-status records have different scopes.`,
      `Historic England lists the Water Tower on Tower Road at Grade II and records deeply recessed double-leaf moulded six-panelled doors and a fanlight in its legacy description. Warwickshire County Council separately identifies Bedworth Library and Information Centre at 18 High Street CV12 8NF. The library address is outside the Gazette's stated 10-16 addition and must not inherit that status from proximity.`,
    ],
    accessGuidance: `Provide the complete Bedworth address, building or unit, exact external, shared or internal opening and authorised controller. At the library, identify the instructed entrance and live site contact rather than using 18 High Street alone. At the Water Tower, confirm the exact listed asset and doorway before referring to the legacy description.`,
    evidenceLimits: `The street register concerns highway maintenance, the Gazette records a bounded 2022 variation, Historic England describes one exact listed asset using legacy text, and the library page identifies one managed venue. None establishes a locality boundary, current use, caller authority, installed hardware, fault, damage, demand, coverage, journey conditions, response time or outcome. The 10-16 High Street addition does not include the separately cited library at number 18.`,
    facts: [
      {
        heading: 'Bedworth town-field street entries',
        text: `The county street register produced on 11 August 2026 lists Acacia Crescent, Alexander Road and All Saints Square with Bedworth in the Town field.`,
        sourceIds: ['wcc-list-of-streets-2026'],
        serviceRelevance: `Use these selected entries to prompt a complete address check only; the highway register does not define a property, approach, controlled opening or authority.`,
      },
      {
        heading: 'Bedworth 2022 High Street addition',
        text: `The Gazette records that Bedworth Town Centre Conservation Area boundary changes were confirmed on 15 February 2022, including the addition of 10-16 High Street.`,
        sourceIds: ['gazette-nuneaton-conservation-2022'],
        serviceRelevance: `Apply the notice only to the exact stated numbers and check the current map before visible alteration; it does not include number 18 or establish a controller, door, hardware or fault.`,
      },
      {
        heading: 'Bedworth Water Tower listed doorway',
        text: `Historic England lists the Water Tower, Tower Road, Bedworth at Grade II as entry 1116416; its legacy description identifies deeply recessed double-leaf moulded six-panelled doors and a fanlight.`,
        sourceIds: ['historic-england-bedworth-water-tower-1116416'],
        serviceRelevance: `The exact-asset record describes the tower as disused and is not a current condition, access, controller, hardware or work-authority survey.`,
      },
      {
        heading: 'Bedworth Library High Street site',
        ...
        serviceRelevance: `This identifies one managed site but no instructed entrance, current keyholder, caller authority, lock, fault or access arrangement; its dynamic hours and notices should not be reused as stable facts.`,
      },
    ],
    sources: [
      LOCAL_SOURCES['wcc-list-of-streets-2026'],
      LOCAL_SOURCES['gazette-nuneaton-conservation-2022'],
      LOCAL_SOURCES['historic-england-bedworth-water-tower-1116416'],
      LOCAL_SOURCES['wcc-bedworth-library'],
    ],
    serviceGuidance: {
      'emergency-lockout': {
        localFactIndexes: [0, 3],
        heading: 'Bedworth lockouts at a street or library threshold',
        body: [
          `Acacia Crescent, Alexander Road and All Saints Square appear with Bedworth in the county register's Town field, but those entries do not identify the locked property or opening. Record the full number, postcode, building or unit and whether the affected threshold is private, shared or internal. For a call at Bedworth Library, use 18 High Street CV12 8NF to distinguish the site, then name the exact public, staff or internal door and the current responsible contact. A published library address provides neither caller authority nor an opening method.`,
          `Verify identity and the requester's connection to that Bedworth threshold before assessing key response, latch or deadlock state, door position and visible damage. At the library, obtain live site instructions rather than relying on dynamic hours or closure notices from the public page. Photograph the door face, frame and visible furniture before removing a component. The MLA service-call material supports available advance price information and identity-and-authority checks; secure agreement before any changed service-call price takes effect. Itemise any drilling, replacement and reinstatement without treating a town-field entry or council venue as permission to enter.`,
        ],
        checks: ['Give the Bedworth number and postal code', 'Specify the locked library or street opening', 'Verify today\'s controller for that threshold'],
      },
      'lock-change': {
        localFactIndexes: [1, 2],
        heading: 'Bedworth lock changes at High Street or Tower Road',
        body: [
          `The Gazette's Bedworth variation identifies 10-16 High Street as the stated addition, while Historic England's Water Tower entry belongs to Tower Road. Establish which exact property and opening is involved and who controls it; neither record authorises a lock change. State whether the objective concerns lost-key control, failure, damage or another documented reason. At the tower, confirm the exact listed asset and current responsible party even though the legacy record describes it as disused. Its recessed double-leaf doors and fanlight do not reveal a present lock or condition.`,
          `Photograph both hardware faces, the edge plate, visible furniture and existing apertures, then record the cylinder, lock case, keep and alignment as separate observations with their own markings and measurements. For a named High Street address, check the current map before visible alteration. At the tower, distinguish compatible work within existing openings from new cutting or outward substitution and obtain current property-specific guidance for fabric decisions. The schedule should state retained material, measured components, keys, fitting and adjustment, while ownership, management and consent questions remain explicit rather than inferred from the variation notice or listing.`,
        ],
        checks: ['Match the Bedworth property to the correct record', 'Confirm the Tower Road controller before key changes', 'Measure retained and replacement hardware separately'],
      },
      'upvc-lock-repair': {
        localFactIndexes: [0, 1, 3],
        heading: 'Bedworth uPVC checks without High Street assumptions',
        body: [
          `The county town-field entries, the 10-16 High Street conservation addition and the library's address do not establish that any Bedworth entrance is uPVC, composite or fitted with a multipoint system. Confirm the complete address and door material directly. At Bedworth Library, identify the precise external, staff or internal opening and authorised site contact. For the Bedworth door, log how the key turns, how far the handle travels and whether each locking point moves, then note any safe contrast between open and closed tests. Those observations describe the selected door but do not by themselves identify the failed part.`,
          `Keep the Gazette number range exact: its stated addition ends at 16 High Street, while the separately sourced library is number 18. Do not transfer the conservation status to the library. Where the booked property is one of numbers 10-16, use the current map only as a visible-fabric prompt. Capture faceplate marks, centres, backset, locking layout, hinge position and frame contact before specifying compatibility. The repair record should separate safe tests, dimensions, controller requirements and any proposed door-or-frame intervention from the mechanism decision, without deriving hardware or condition from an address source.`,
        ],
        checks: ['Confirm material at the booked Bedworth door', 'Keep number 18 outside the stated addition', 'If a multipoint system is confirmed, record its full locking layout'],
      },
      'boarding-up': {
        localFactIndexes: [2, 3],
        heading: 'Bedworth boarding at tower or library openings',
        body: [
          `A boarding instruction at the listed Water Tower and one at Bedworth Library concern different sites, controllers and fabric. Confirm Tower Road or 18 High Street CV12 8NF, name the exact damaged door or window and identify the person authorised to direct temporary securing. Neither source reports an incident or the present construction of an opening. Follow current police scene directions before disturbance, then photograph the point of entry, surviving frame, glazing or door, damaged hardware and adjacent surfaces before any covering hides them.`,
          `At the tower, distinguish the affected opening from the legacy double-leaf-door and fanlight description and obtain current property-specific advice for verified listed material; a disused-use description does not identify today's controller. At the library, obtain live site instructions and identify the actual public, staff or internal opening rather than using the venue address alone. Record opening measurements, remaining material, the selected temporary method and what will be concealed. List unresolved glazing, joinery, door, lock or structural work separately, because neither official page supplies a temporary construction decision or permission for permanent change.`,
        ],
        checks: ['Name the damaged Bedworth managed-site opening', 'Preserve tower or library evidence before covering', 'Record temporary and permanent decisions separately'],
      },
      'lock-upgrade': {
        localFactIndexes: [1, 2, 3],
        heading: 'Bedworth upgrades with three property records separated',
        body: [
          `The 10-16 High Street addition, listed Tower Road water tower and library at 18 High Street are three distinct Bedworth records. None reports existing security or selects a product, and number 18 must not inherit the status stated for numbers 10-16. Identify the exact address, opening and controller before inspecting the selected leaf, frame, hinges, keeps, handles, lock engagement and any cylinder projection. At the library, obtain the site's current access, egress and key-management requirements; at the tower, verify the listed asset and affected doorway.`,
          `Historic England's recessed double-leaf doors and fanlight are legacy fabric descriptions, not present-condition findings. Photograph existing apertures and retained visible material, then separate adjustment, aperture-compatible component work and any new outward cutting or substitution requiring current property-specific guidance. For a High Street address in the notice, check the current map; for the library, use its address only to identify the managed site. Each proposed option should cite current manufacturer evidence and measured fit, identify retained parts and list owner, facilities, alignment or fabric dependencies without claiming that one item provides complete protection.`,
        ],
        checks: ['Distinguish all three Bedworth property records', 'Survey the selected tower or library entrance', 'Match current product evidence to measured fit'],
      },
    },
  }),
  ...
  cawston: makeGuide({
    ...
    reviewedOn: PROMOTION_REVIEWED_ON,
    summary: [
      `Warwickshire County Council lists Cawston Grange Primary School at Scholars Drive CV22 7GU, while Rugby Borough Council gives Cawston Community Hall at the same postcode as the parish council's contact location. These are separate managed-site records, not proof of a particular entrance or controller.`,
      `Historic England lists Cawston Farm House on Coventry Road at Grade II. The county's Rugby Bus Map, dated 30 August 2025, separately labels Cawston, Cawston Lane and Cawston Grange Drive for orientation only.`,
    ],
    accessGuidance: `Provide the complete Cawston postal address, building or unit, exact affected entrance, responsible controller and current site-access instructions. The school and hall records, farmhouse listing and dated county map cannot supply those booking details.`,
    evidenceLimits: `The school and parish records identify contact locations, the listing applies only to Cawston Farm House and the map supplies dated orientation. They do not identify a service entrance, present controller, access, route, journey time, neighbouring property status, construction, hardware, condition, demand or locksmith performance.`,
    facts: [
      {
        heading: 'Cawston Grange Primary School directory',
        text: `Warwickshire County Council lists Cawston Grange Primary School as an academy at Scholars Drive, Rugby CV22 7GU.`,
        sourceIds: ['wcc-cawston-grange-primary-school'],
        serviceRelevance: `The directory identifies one managed site only; it supplies no particular entrance, present controller, access instruction, construction or hardware.`,
      },
      {
        heading: 'Cawston Community Hall contact location',
        text: `Rugby Borough Council's current parish-council directory gives Cawston Community Hall, Scholars Drive, Rugby CV22 7GU as the parish council contact location.`,
        sourceIds: ['rbc-cawston-parish-council'],
        serviceRelevance: `A contact location does not identify a hall entrance, current site controller, keyholder, access instruction or authority to commission work.`,
      },
      {
        heading: 'Cawston Farm House listed status',
        text: `Historic England records Cawston Farm House on Coventry Road as Grade II listed, entry 1390996, and places the named asset in Dunchurch parish.`,
        sourceIds: ['historic-england-cawston-farm-house-1390996'],
        serviceRelevance: `The designation is asset-specific and does not establish current fabric, access, fitted hardware, condition or the status of another Cawston address.`,
      },
      {
        heading: 'Dated Cawston map orientation',
        ...
        serviceRelevance: `The map is dated orientation evidence only, so a booking still needs the full street, postcode, unit and affected entrance.`,
      },
    ],
    sources: [
      LOCAL_SOURCES['wcc-cawston-grange-primary-school'],
      LOCAL_SOURCES['rbc-cawston-parish-council'],
      LOCAL_SOURCES['historic-england-cawston-farm-house-1390996'],
    ...
    serviceGuidance: {
      'emergency-lockout': {
        ...
        body: [
          ...
          `The school directory identifies a managed campus but not the locked gate, block or room, and the dated map cannot fill that gap. For a school instruction, obtain the named facilities contact and an exact meeting point independently; do not infer authority from the directory. Before an opening method removes a component or marks surrounding material, photograph the door and state the selected method, affected component and reinstatement. MLA guidance supports verifying identity and authority and giving available price information in advance. Obtain agreement before a changed service-call price applies.`,
        ],
      ...
      'lock-change': {
        ...
        body: [
          ...
          `Cawston Community Hall is recorded only as the parish council's contact location. If that named venue is involved, identify the exact hall opening and obtain the present authorised controller independently; a directory address is not work authority. Keep measured component work separate from any proposed change to the door or frame. The written schedule should identify retained components, measured replacements, supplied keys, fitting, adjustment and any separately approved building-management dependency.`,
        ],
      ...
      'upvc-lock-repair': {
        ...
        body: [
          `The school directory and parish contact record distinguish two named Scholars Drive sites, but neither establishes that a Cawston entrance is uPVC, composite or fitted with a multipoint mechanism. Identify the organisation, unit and exact door, confirm its material, and record key rotation, handle travel, locking-point movement and the difference between open-door and closed-door operation. Faceplate marks, centres, backset, locking layout and frame contact must be measured before alignment work or a compatible part is proposed.`,
          `The school and hall records share a postcode but do not establish that either relevant entrance has a multipoint system. Distinguish the organisation and exact threshold, then establish the present controller before removing components. If the repair would extend beyond the mechanism into the door or frame, document that separately. The diagnostic record should separate reported symptoms, safe tests, measurements, authority and the approved repair scope; neither directory can supply the diagnosis.`,
        ],
      ...
      'boarding-up': {
        ...
        body: [
          ...
          `For Cawston Community Hall, identify the affected opening and responsible venue contact independently. At Cawston Farm House, first verify that the incident concerns the exact Grade II asset rather than relying on the place name, then record surviving listed fabric before temporary work. Define coverage from inspected damage only. The completion note should distinguish concealed material, temporary work and outstanding glazing, joinery, door, lock, heritage or structural assessment so permanent decisions remain evidence-led.`,
        ],
      ...
      'lock-upgrade': {
        ...
        body: [
          `The school directory and Cawston Farm House designation provide no security rating for an entrance. Inspect the booked door leaf, frame, hinges, keeps, handles, lock engagement, protective furniture and cylinder fit as one assembly. Warwickshire Police guidance supports a complete-door review and correctly sized, accredited products, but the option still depends on current markings, dimensions and operation. A managed-site record or listed status cannot establish fitted hardware, weakness, condition or a guaranteed outcome.`,
          `At the named school, confirm the responsible facilities contact and exact entrance independently. At Cawston Farm House, verify the listed asset and separate work within existing apertures from cutting or visible fabric change; the designation is not a condition survey. The specification should separate adjustment, reinforcement and replacement, cite current manufacturer evidence, state measured fit and record management or property-specific heritage dependencies. It must remain specific to the inspected entrance rather than becoming a Cawston-wide product recommendation.`,
        ],
  ...
  'new-bilton': makeGuide({
    ...
    summary: [
      ...
      `The council's September 2024 study analysed New Bilton Inner and Outer separately. A 14 March 2024 council update said orchard work had started at Jubilee Recreation Ground in Bridle Road, while the county's 30 August 2025 map labels New Bilton. Each record is bounded and dated.`,
    ],
    ...
    evidenceLimits: `The direction concerns a narrowly defined planning change, the study uses analytical areas, the orchard update records work starting on one date and the map supplies orientation. They do not prove present completion, condition, access, HMO use, tenure, management, authority, construction, hardware, demand, routing or locksmith performance.`,
    facts: [
      {
      ...
      {
        heading: 'New Bilton Inner and Outer study areas',
        ...
        serviceRelevance: `These analytical labels are not booking boundaries and supply no address, entrance, controller, access or hardware information.`,
      },
      {
        heading: 'Dated Jubilee Recreation Ground orchard work',
        text: `A Rugby Borough Council update dated 14 March 2024 said work had started on a community orchard at Jubilee Recreation Ground, described as the recreation ground in Bridle Road.`,
        sourceIds: ['rbc-new-bilton-orchard-2024'],
        serviceRelevance: `The dated update does not prove current completion, condition, access, a particular opening or who can authorise locksmith work at the ground.`,
      },
      {
        heading: 'Dated New Bilton map label',
        text: `Warwickshire County Council's Rugby Bus Map, dated 30 August 2025, labels New Bilton separately within Rugby.`,
        sourceIds: ['wcc-rugby-bus-map-2025'],
        serviceRelevance: `The label supplies dated orientation only and cannot identify a postal address, property status, threshold, access instruction or route.`,
      },
    ],
    sources: [
      LOCAL_SOURCES['rbc-new-bilton-hmo-article-4'],
      LOCAL_SOURCES['rbc-local-centres-study-2024'],
      LOCAL_SOURCES['rbc-new-bilton-orchard-2024'],
      LOCAL_SOURCES['wcc-rugby-bus-map-2025'],
    ],
    serviceGuidance: {
      'emergency-lockout': {
        ...
        body: [
          `The dated county map labels New Bilton but cannot locate a customer's locked door. Record the full postal address, building and unit, exact private or shared entrance, current access instructions and the person controlling that opening. Verify identity and authority for the threshold before comparing latch state, deadlocking, key behaviour, alignment and visible damage. Neither the map label nor ward inclusion in the Article 4 record supplies a mechanical or property conclusion.`,
      ...
      'upvc-lock-repair': {
        ...
        body: [
          `The 14 March 2024 orchard update and dated county map show neither that a New Bilton entrance is uPVC or composite nor that it has a multipoint system. Confirm the material at the exact unit, then record key rotation, handle travel, locking-point movement and differences between open-door and closed-door operation. Capture faceplate markings, centres, backset, locking layout, hinge position and frame contact before diagnosing alignment or identifying a compatible mechanism.`,
          `If Jubilee Recreation Ground is named, distinguish the precise Bridle Road opening from the wider ground and obtain the present responsible controller independently. The 2024 statement that orchard work had started does not prove current completion, condition, access or any door hardware. For every address, establish threshold control before removing components. If repair extends into the door or frame, document that separately. The record should separate symptoms, safe tests, dimensions, authority and the inspection-supported decision.`,
        ],
      ...
      'lock-upgrade': {
        ...
        body: [
          `The Article 4 direction and dated county map provide no security evidence for New Bilton doors. Assess the identified entrance across its leaf, frame, hinges, keeps, handles, lock engagement, protective furniture and cylinder fit. Warwickshire Police guidance supports reviewing the complete assembly and correctly sized, accredited products, while actual marks, measurements and operation determine the available options. No local hardware, weakness, condition or outcome can be inferred from either record.`,
          `Article 4 coverage does not show that the property is an HMO or that its entrance is shared. The dated orchard record applies only to Jubilee Recreation Ground and supplies no current condition, controller or security requirement; the county map is orientation only. Confirm the responsible controller before changing communal or managed hardware. The specification should separate adjustment, reinforcement and replacement, cite current manufacturer evidence, document measured fit and list management dependencies requiring distinct approval. Recommendations remain specific to the inspected door set.`,
        ],
