...
const LOCAL_SOURCES = {
  ...
  'wcc-list-of-streets-2026': {
    ...
    supports: 'The 11 August 2026 county street-to-locality labels, including selected Attleborough, Stockingford, Weddington, Horeston Grange, Whitestone, Camp Hill, Chapel End and Galley Common entries, Tiverton Drive\'s Horeston Grange label, Camp Hill Road\'s blank locality, and Bermuda-labelled roads in Nuneaton.',
    checkedOn: PROMOTION_REVIEWED_ON,
    kind: 'locality',
  },
