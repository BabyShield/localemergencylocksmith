  ...
  },
  {
    ...
    contexts: {
      ...
      'lock-upgrade': {
        ...
        local: `The New Milverton character area, Northumberland Road allotment policy and Grade II Milverton House entry answer three different property-status questions; none demonstrates a security deficiency. Establish the authorised objective for the exact entrance and inspect its frame, hinges, keeps, handles, lock engagement and cylinder fit where applicable. Link each proposed measure to an observed condition rather than to conservation, allotment protection or listed status.`,
        decision: `Use the complete address to decide whether the current character-area boundary or the Milverton House entry applies, and keep any resulting permission check separate from product selection. The allotment policy supplies no performance requirement. Present measured compatibility, relevant product evidence, retained components and excluded fabric or communal work in writing, attributing any manager or insurer requirement to its provider and avoiding any implication of authority endorsement.`,
        checks: [
  ...
  },
  {
    ...
    contexts: {
      'emergency-lockout': {
        ...
        local: `The 2024-25 report describes several Lower Heathcote Local Centre elements at a dated point, while the school register identifies Heathcote Primary on Vickers Way. Neither record identifies the doorway in an urgent request. Record the complete address, unit or institution, entrance position and whether the threshold is private, shared or managed before deciding which site, if either, the caller means.`,
