  ...
  },
  {
    ...
    contexts: {
      ...
      'boarding-up': {
        ...
        decision: `Follow any police evidence-preservation direction before inspection. Once released, photograph the point of entry, surviving frame, glazing or door material, damaged hardware and adjacent surfaces before coverage. Measure the authorised opening and record the intended temporary boundary and each proposed contact point, leaving hidden support capacity unresolved. Neither plan status nor a library address approves an attachment. The handover should identify what was covered and separate glazing, joinery, door, lock and structural follow-up from permanent reinstatement, with property-specific approval recorded for the actual site.`,
        checks: [
          `Distinguish the damaged premises and opening from the named Kenilworth Road library.`,
          `After any police direction, document visible material, coverage and proposed contact points for the authorised opening.`,
        ],
      },
      'lock-upgrade': {
        localFactIndexes: [0, 1, 3],
  ...
  },
  {
    ...
    contexts: {
      ...
      'boarding-up': {
        ...
        decision: `Follow any police evidence-preservation direction before inspection. Once released, record opening dimensions, the area to be covered, visible damage, compromised locks and proposed attachment positions, while leaving concealed structure unresolved. Verify the current controller of the exact premises; a library web page does not name one, and a list entry does not confer work authority. Resolve conservation or listed-building questions against that asset and temporary proposal, considering listed-building consent only where work to a verified listed building could affect special interest. Document the permanent repair still outstanding without treating temporary protection as final reinstatement.`,
        checks: [
          `Identify the damaged Meriden opening without transferring the library or church record to a nearby address.`,
          `After any evidence-preservation direction, document visible substrate and proposed attachment positions for the verified asset.`,
        ],
      },
      'lock-upgrade': {
        localFactIndexes: [0, 1, 3],
  ...
  },
  {
    ...
    contexts: {
      ...
      'boarding-up': {
        ...
        decision: `Follow any police evidence-preservation direction before inspection. After release, make a visual record of the entry point, surviving frame, glazing or door material, damaged hardware and adjoining surfaces before they are covered. At the church, identify retained visible fabric and obtain proposal-specific property guidance; at the school, confirm the gate, block or opening with the responsible site contact. Measure the authorised opening, state intended coverage and each proposed contact point, and list glazing, joinery, door, lock and structural follow-up separately. Leave concealed support capacity and permanent reinstatement unresolved until inspected and approved.`,
        checks: [
          `Name the school or church opening and its current authorised controller before proposing coverage.`,
          `After any police direction, record visible fabric, intended coverage and proposed contact points.`,
        ],
      },
      'lock-upgrade': {
        localFactIndexes: [0, 1, 3],
